...
class TestCoach:
    ...
    def test_executeEpisode(self, mocker):
        ...
        self.coach.game.getNextState = mocker.MagicMock(return_value=(self.game.getInitBoard(), 1))
    ...
    def test_learn(self, mocker):
        self.coach.executeEpisode = mocker.MagicMock(return_value=[(self.game.getInitBoard(), 1, [1], 1)])
